...
from backend.providers.dns_resolver import DNSStatus, resolve_domain
from backend.providers.geo_service import get_geolocation
from backend.providers.normalizer import GeoStatus
from backend.utils.validator import InputType, validate_input
...
def perform_lookup(
    ...
    def _finalize_result(res: LookupResult) -> LookupResult:
        if save_to_db:
            try:
                from backend.database.db import save_lookup
