...
import pytest
pytest.importorskip("matplotlib", reason="matplotlib is optional (used for legacy charts)")
import pandas as pd

from backend.analytics.analyzer import (
    compute_descriptive_stats,
    compute_distributions,
    compute_missing_data_report,
    load_and_validate_dataset,
)
from backend.reports.visualizer import generate_all_charts
