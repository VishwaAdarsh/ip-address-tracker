...
from backend.providers.dns_resolver import DNSResult, DNSStatus
from backend.providers.normalizer import GeoResult, GeoStatus
...
class TestLookupService(unittest.TestCase):
    ...
    @patch("backend.services.lookup_service.get_geolocation")
    ...
    @patch("backend.services.lookup_service.get_geolocation")
    @patch("backend.services.lookup_service.resolve_domain")
