...
class TestPhase19FieldStudySuite(unittest.TestCase):
    ...
    # -------------------------------------------------------------------------
    @patch("backend.services.field_test_service.perform_lookup")
    @patch("backend.services.risk_analysis_service.perform_full_intelligence_scan")
    ...
    def test_16_optional_automatic_completion(self):
        ...
        with patch("backend.services.field_test_service.add_field_observation") as mock_add:
